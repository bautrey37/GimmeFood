...
package ee.ut.gimmefood.camera;
...
public class GraphicOverlay extends View {
   ...
   * instances to the overlay using {@link ee.ut.gimmefood.camera.GraphicOverlay#add(Graphic)}.
   */
  public abstract static class Graphic {
    private ee.ut.gimmefood.camera.GraphicOverlay overlay;

    public Graphic(ee.ut.gimmefood.camera.GraphicOverlay overlay) {
